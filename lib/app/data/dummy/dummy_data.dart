...
class DummyData {
  static List<Destination> get destinations => [
    Destination(
      id: '1',
      name: 'Santorini',
      description: 'A stunning Greek island known for its white buildings, blue domes, and spectacular sunsets over the Aegean Sea.',
    ...
    Destination(
      id: '2',
      name: 'Kyoto',
      description: 'Ancient capital of Japan, famous for its classical Buddhist temples, gardens, imperial palaces, and traditional wooden houses.',
    ...
    Destination(
      id: '4',
      name: 'Iceland',
      description: 'Land of fire and ice, featuring dramatic landscapes with waterfalls, geysers, and the Northern Lights.',
      imageUrl: 'https://images.unsplash.com/photo-1539650116574-75c0c6d73d1e?w=800',
      gallery: [
      ...
      activities: ['Northern Lights', 'Golden Circle', 'Blue Lagoon', 'Glacier Hiking'],
      location: {
        'lat': 64.1466,
        'lng': -21.9426,
      },
    ...
    Destination(
      id: '5',
      name: 'Bali',
      description: 'Indonesian paradise known for its lush rice terraces, ancient temples, and vibrant cultural scene.',
      ...
      activities: ['Temple Tours', 'Yoga Retreats', 'Rice Terrace Walks', 'Cooking Classes'],
      location: {
        'lat': -8.5069,
        'lng': 115.2625,
      },
    ...
    Destination(
      ...
      activities: ['Inca Trail', 'Sacred Valley', 'Llama Encounters', 'Archaeological Tours'],
      location: {
        'lat': -13.1631,
        'lng': -72.5450,
      },
  ...
  static List<TravelPackage> get travelPackages => [
    TravelPackage(
      ...
      description: 'Explore the most beautiful Greek islands including Santorini, Mykonos, and Crete in this 10-day adventure.',
      imageUrl: 'https://images.unsplash.com/photo-1570077188670-e3a8d69ac5ff?w=800',
      gallery: [
        'https://images.unsplash.com/photo-1570077188670-e3a8d69ac5ff?w=800',
        'https://images.unsplash.com/photo-1533105079780-92b9be482077?w=800',
      ...
      itinerary: {
        ...
        'day2-4': 'Explore Santorini - Oia sunset, wine tasting, volcanic tour',
    ...
    TravelPackage(
      ...
      description: 'Immerse yourself in Japanese culture with visits to Tokyo, Kyoto, and Mount Fuji.',
      imageUrl: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=800',
      gallery: [
        'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=800',
        'https://images.unsplash.com/photo-1528164344705-47542687000d?w=800',
      ...
      itinerary: {
        ...
        'day6-10': 'Kyoto cultural immersion - traditional temples, tea ceremony',
    ...
    TravelPackage(
      ...
      description: 'Ultimate luxury experience with overwater villas, private beaches, and world-class diving.',
      imageUrl: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800',
      gallery: [
        'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800',
        'https://images.unsplash.com/photo-1573843981267-be1999ff37cd?w=800',
  ...
  static List<Map<String, dynamic>> get reviews => [
    {
      ...
      'rating': 5.0,
      'comment': 'Amazing experience! The app made planning my trip so easy.',
      'date': '2024-01-15',
    ...
    },
    {
      ...
      'rating': 4.9,
      'comment': 'The AR features are incredible! Made exploring so much fun.',
      'date': '2024-01-08',
      'destination': 'Bali',
    },
  ];
